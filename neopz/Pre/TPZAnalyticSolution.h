...
struct TLaplaceExample1 : public TPZAnalyticSolution
{
    ...
    enum EExactSol {ENone, EConst, EX, ESteepMountain2D, ESinSin, ECosCos,  EArcTan, EArcTanSingular, ESteepWave, ESinDist, E10SinSin,E2SinSin, ESinSinDirNonHom,ESinMark,ESinMarkHom,ELineSingularity,ESharpGaussian2D,ESteklovNonConst,EGalvisNonConst,EMultiPerm,EBoundaryLayer,EBubble, EBubble2D,EBubble2DTemp,ESinCosCircle, EHarmonic, EHarmonic2,
